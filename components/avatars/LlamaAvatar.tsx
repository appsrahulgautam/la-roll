  ...
  return (
    ...
    >
      ...
      >
        ...
        {reaction && (
          <motion.div
            className="absolute -top-1 left-1/2 -translate-x-1/2 font-bold text-xs bg-pink-100 text-[#503322] px-2 py-0.5 rounded-full border border-pink-300 shadow-sm whitespace-nowrap z-50"
