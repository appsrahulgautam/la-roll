  ...
  return (
    ...
    >
      ...
      >
        ...
        {reaction && (
          <motion.div
            className="absolute -top-3 left-1/2 -translate-x-1/2 font-bold text-xs bg-slate-100 text-[#503322] px-2 py-0.5 rounded-full border border-slate-300 shadow-sm whitespace-nowrap z-50"
